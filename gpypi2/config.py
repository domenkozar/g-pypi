...
class Config(dict):
    ...
    allowed_options = {
        ...
        # metagen
        'metagen_disable': ("Disable metadata generation", bool, False),
        'metagen_disable_echangelog_user': ("Don't use ECHANGELOG_USER", bool, False),
        'metagen_herd': ("Herd for ebuild metadata", str, ""),
        'metagen_maintainer_description': ("Maintainer description for ebuild metadata", str, ""),
        'metagen_maintainer_email': ("Maintainer email for ebuild metadata", str, ""),
        'metagen_maintainer_name': ("Maintainer name for ebuild metadata", str, ""),
        # echangelog
        'echangelog_disable': ("Disable echangelog", bool, False),
        'echangelog_message': ("Echangelog commit message", str, "Initial ebuild generated by gpypi2"),
        # repoman
